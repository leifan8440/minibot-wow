...
- Start **MiniBot**, register a new user and login. (Notice you can only login to one PC at the same time, so the second login will cause the previous game sessions being invalidated)
